...
var contrataciones = require('../service/contrataciones_service');
...
async function get_dependencias (req, res, next) {
     ...
     if(code.code == 401){
         ...
         let dependencias = await contrataciones.getDependencias();
         utils.writeJson(res,dependencias);
     }
};

module.exports.post_contrataciones = function post_contrataciones (req, res, next) {
    ...
    if(code.code == 401){
        ...
        contrataciones.post_contrataciones(body)
